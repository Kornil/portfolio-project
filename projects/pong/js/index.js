...
var Game = React.createClass({
  ...
  update: function update() {
    ...
    var paddle1Y = Height / 2 - paddleWidth / 2,
    ...
    var moveAll = function moveAll() {
      ...
      if (ballX > Width || ballX < 0) {
        ...
        if (ballX > Width / 2 && ballY >= paddle2Y && ballY <= paddle2Y + paddleWidth) {
          ballSpeedX = -ballSpeedX;
          var deltaY = ballY - (paddle2Y + paddleWidth / 2);
          ballSpeedY = deltaY * 0.35;
        } else if (ballX < Width / 2 && ballY >= paddle1Y && ballY <= paddle1Y + paddleWidth) {
          ballSpeedX = -ballSpeedX;
          var deltaY = ballY - (paddle1Y + paddleWidth / 2);
          ballSpeedY = deltaY * 0.35;
        } else {
          if (ballX < Width / 2) {
            player2Score++;
  ...
  render: function render() {
    return React.createElement(
      ...
      React.createElement(
        "button",
        { className: "buttons", id: "butt1" },
        "vs Computer"
      ),
      React.createElement(
        "button",
        { className: "buttons", id: "butt2" },
        "2 Players"
      )
    );
  }
